								...
								<div class="card-body d-block">
									<div class="transaction">
										<div class="transaction-blog">
											<div class="">
												<svg class="wd-30 ht-40 me-3 my-auto" fill="#01b8ff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
											...
											<div class="transaction-details d-flex">
												<div>
													<span class="text-dark tx-bold-12"> Account Balance</span>
													<h5 class="text-muted tx-bold-12" id="balance"> $0.00</h5>
												</div>
									...
									<div class="transaction">
										<div class="transaction-blog">
											...
											<div class="transaction-details d-flex">
												<div>
													<span class="text-dark tx-bold-12"> Subscription Balance</span>
													<h5 class="text-muted tx-bold-12" >$<?= number_format($acct_row['sub_balance'], 2) ?></h5>
												</div>
												<div class="ms-auto fs-14 text-danger font-weight-normal">
													<a href="" class="btn ripple btn-success-transparent">Live</a>
												</div>
													...
													<table class="table table-borderless text-nowrap text-md-nowrap table-hover mg-b-0">
														<tbody>
															<tr>
																...
																<td>Bitcoin</td>
																<td><span id="btc-balance-eq"></span> BTC</td>
															...
															<tr>
																...
																<td>Ethereum</td>
																<td><span id="eth-balance-eq"></span> ETH</td>
													...
													<table class="table table-borderless text-nowrap text-md-nowrap table-hover mg-b-0">
														<tbody>
															<tr>
																<td><img src="../main/assets/img/svgs/crypto-currencies/btc.svg" class="wd-25 ht-20 me-3 my-auto" alt=""></td>
																<td>Bitcoin</td>
																<td><?= number_format($acct_row['account_balance'] / $btc, 8) ?> BTC</td>
																<td>$<?= number_format($acct_row['account_balance'], 2) ?></td>
																<td>
																	<a href="withdrawal.php" class="btn ripple btn-dark-transparent">Withdraw</a>
																	<a href="#" data-bs-target="#depositmodal" data-bs-toggle="modal" class="btn ripple btn-primary-transparent">Deposit</a>
								...
								<div id="Crypto" style="display:none;">
									<div class="row row-sm mg-b-20">
										<div class="col-lg-12">
											...
											<select name="currency_pair_crypto" class="form-control select2-no-search">
										...
										<div class="d-flex">
											<span class="text-dark tx-semibold">Balance ~ <font color="teal">₱<?= number_format($acct_row['account_balance'], 2) ?></font></span>

											<div class="ms-auto fs-14 text-dark tx-semibold">Current Price ~ <font color="teal">$0.00</font>
											</div>
										</div>
									</div>
								...
								<div id="Forex" style="display:none;">
									...
									<div class="row row-sm mg-b-20">
										<div class="col-lg-12">
											...
											<select name="currency_pair_forex" class="form-control select2-no-search">
			...
			<div class="row row-sm">
				<div class="col-sm-12 col-md-12 col-lg-12 col-xl-8 col-xxl-8">
					<div class="card custom-card overflow-hidden">
						<div class="card-header border-bottom">
							<div>
								<h3 class="card-title tx-18"><label class="main-content-label tx-15">TRADES</label></h3>
							</div>
						</div>
							...
							<div class="table-responsive">
								<table class="table table-borderless text-nowrap text-md-nowrap table-hover mg-b-0">
									<tbody>
										...
										<?php $trade_stmt = $conn->query("SELECT * FROM trade_history WHERE user_id = '$user'"); ?>
							...
							<div class="card custom-card">
								...
								<div class="card-body">
									...
									<div class="transaction">
										<div class="transaction-blog">
											<div class="">
												<svg class="wd-30 ht-40 me-3 my-auto" fill="#01b8ff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
											...
											<div class="transaction-details d-flex">
												<div>
													...
													<h5 class="text-muted tx-bold-12"> $<?= number_format($deposit_row['total_deposit'] ?? 0, 2) ?></h5>
												</div>
												<div class="ms-auto fs-14 text-danger font-weight-normal">
										...
										<div class="transaction-blog">
											...
											<div class="transaction-details d-flex">
												<div>
													...
													<h5 class="text-muted tx-bold-12"> $<?= number_format($withdraw_row['total_withdrawal'] ?? 0, 2) ?></h5>
												</div>
												<div class="ms-auto fs-14 text-danger font-weight-normal">
									...
									<div class="transaction">
										<div class="transaction-blog">
											...
											<?php elseif ($acct_row['status'] == 2): ?>
												<p class="text-muted tx-bold-12"> Fully verified.</p>
											</div>
											<div class="ms-auto fs-14 text-danger font-weight-normal">
										...
										<?php else: ?>
											...
											<p class="text-muted tx-bold-12"> Under Review.</p>
										</div>
										<div class="ms-auto fs-14 text-danger font-weight-normal">
...
<?php $trade_stmt2 = $conn->query("SELECT * FROM trade_history WHERE user_id = '$user'"); ?>

<?php while ($row = $trade_stmt2->fetch()): ?>
			...
			<div class="modal-content modal-content-demo">
				...
				<div class="modal-body modal-body pd-y-20 pd-x-20">
					...
					<div class="text-wrap">
						<div class="example">
							<div class="d-flex">
								<span class="text-dark tx-semibold"> Profit:</span>
								<div class="ms-auto fs-14 text-dark tx-semibold">₱<?= $row['trade_profit'] ?></div>
							</div>
					...
					<div class="text-wrap">
						<div class="example">
							<div class="d-flex">
								...
								<div class="ms-auto fs-14 text-dark tx-semibold"><?php if ($row['trade_result'] == 'Win') {
																						echo '<span class="badge badge-success">' . $row['trade_result'] . '</span>';
																					} elseif ($row['trade_result'] == 'Loss') {
																						echo '<span class="badge badge-danger">' . $row['trade_result'] . '</span>';
																					} else {
...
<script>
	async function get_trading_balance() {
		...
		const trading_balance = await response.json();


		$('#eth-balance').html(formatter.format(trading_balance['ETH_BALANCE']))
		$('#btc-balance').html(formatter.format(trading_balance['BTC_BALANCE']))

		balance = parseFloat(trading_balance['ACCOUNT_BALANCE'])
		...
		$('#eth-balance-eq').html((parseFloat(trading_balance['ETH_BALANCE']) * rates['BTC']).toFixed(8))
		$('#btc-balance-eq').html((parseFloat(trading_balance['BTC_BALANCE']) * rates['ETH']).toFixed(8))
