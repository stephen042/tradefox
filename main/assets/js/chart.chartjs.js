$(function() {
	...
	var datapie = {
		...
		datasets: [{
			...
			backgroundColor: ['#1199FA', '#53caed', '#01b8ff', '#f16d75', '#29ccbb', '#f1388b']
		}]
	};
	var optionpie = {
		maintainAspectRatio: false,
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			datasets: [{
				data: [18, 15, 9, 6, 19],
				backgroundColor: ['#1199FA', '#53caed', '#01b8ff', '#f16d75', '#29ccbb'],
				hoverBackgroundColor: ['#1199FA', '#53caed', '#01b8ff', '#f16d75', '#29ccbb'],
