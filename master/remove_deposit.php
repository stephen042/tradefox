...
if(isset($_GET['id'])){
    ...
    try {
        ...
        $conn->query("DELETE FROM deposit WHERE id = '$deposit_id'");
        $conn->commit();

        set_message('<div class="alert alert-success"><i class="fa fa-info-circle"></i> Deposit request was successfully deleted</div>');
